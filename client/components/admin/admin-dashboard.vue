<template lang='pug'>
  v-container(fluid, grid-list-lg)
    v-layout(row, wrap)
      v-flex(xs12)
        .admin-header
          img.animated.fadeInUp(:src='$helpers.withAssetPath(`svg/icon-browse-page.svg`)', alt='Dashboard', style='width: 80px;')
          .admin-header-title
      ...
      v-flex(xs12)
        v-card.dashboard-contribute.animated.fadeInUp.wait-p4s
          v-card-text
            img(:src='$helpers.withAssetPath(`svg/icon-heart-health.svg`)', alt='Contribute', style='height: 80px;')
            .pl-5
