<template lang='pug'>
  v-container(fluid, grid-list-lg)
    v-layout(row wrap)
      v-flex(xs12)
        .admin-header
          img.animated.fadeInUp(:src='$helpers.withAssetPath(`svg/icon-triangle-arrow.svg`)', alt='Navigation', style='width: 80px;')
          .admin-header-title
                ...
                v-list(nav, two-line)
                  v-list-item-group(v-model='config.mode', mandatory, :color='$vuetify.theme.dark ? `teal lighten-3` : `teal`')
                    v-list-item(value='TREE')
                      v-list-item-avatar
                        img(:src='$helpers.withAssetPath(`svg/icon-tree-structure-dotted.svg`)', alt='Site Tree')
                      v-list-item-content
                    ...
                    v-list-item(value='STATIC')
                      v-list-item-avatar
                        img(:src='$helpers.withAssetPath(`svg/icon-features-list.svg`)', alt='Static Navigation')
                      v-list-item-content
                    ...
                    v-list-item(value='MIXED')
                      v-list-item-avatar
                        img(:src='$helpers.withAssetPath(`svg/icon-user-menu-male-dotted.svg`)', alt='Custom Navigation')
                      v-list-item-content
                    ...
                    v-list-item(value='NONE')
                      v-list-item-avatar
                        img(:src='$helpers.withAssetPath(`svg/icon-cancel-dotted.svg`)', alt='None')
                      v-list-item-content
